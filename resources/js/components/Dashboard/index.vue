<template>
    <div class="container-fluid">
        <div
            ...
            :class="[changeActive ? 'open col' : 'col', token ? 'navigation-login' : '']"
        >
                ...
                <ul class="ps-2 mb-3 ul-responsive">
                    ...
                    <li :class="servicesActive ? 'list active' : 'list'" style="--clr: #000">
                        <a href="#" @click.prevent="activeLink('services')">
                            ...
                            <span class="text">
                                <template v-if="idRol === 1"> Pedidos </template>
                                <template v-if="idRol === 2 || idRol === 3"> Mis pedidos </template>
                            </span>
                        </a>
                    </li>
                    <li v-if="idRol !== 3" :class="shopsActive ? 'list active' : 'list'" style="--clr: #000">
                        <a href="#" @click.prevent="activeLink('shops')">
                            <span class="icon"><i class="bi bi-shop"></i></span>
                            <span v-if="idRol === 1" class="text"> Tiendas </span>
                            <span v-else-if="idRol === 2" class="text"> Mi tienda </span>
                        </a>
                    </li>
                    <li v-if="idRol === 1" :class="categoriesActive ? 'list active' : 'list'" style="--clr: #000">
                    ...
                    <li v-if="idRol === 1" :class="usersActive ? 'list active' : 'list'" style="--clr: #000">
                    ...
                    <li v-if="idRol === 1" :class="rolesActive ? 'list active' : 'list'" style="--clr: #000">
            ...
            <button type="button" class="btn btn-closesesion" @click="activeLink('sesion')">
