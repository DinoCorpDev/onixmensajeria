    ...
    >
      ...
      <div class="w-100">
        <div class="avatar mb-5 mt-5">
          <span class="icon mb-2"><i class="bi bi-person-circle"></i></span>
        ...
        <ul class="ps-2 mb-5 ul-responsive">
          ...
          <li
            ...
            style="--clr: #000;"
          >
            <a href="#" v-on:click="activeLink('services')">
              <span class="icon"><i class="bi bi-app-indicator"></i></span>
              <span class="text">
                <template v-if="user.id_rol == 1">Pedidos</template>
                <template v-if="user.id_rol == 2">Mis Pedidos</template>
              </span>
            </a>
          </li>
          <li
            ...
            style="--clr: #000;"
          >
            <a href="#" v-on:click="activeLink('shops')">
              <span class="icon"><i class="bi bi-shop"></i></span>
              <span v-if="user.id_rol == 1" class="text">Tiendas</span>
              <span v-else-if="user.id_rol == 2" class="text">Mi tienda</span>
            </a>
          </li>
          <li
            v-if="user.id_rol == 1"
            ...
            style="--clr: #000;"
          >
            <a href="#" v-on:click="activeLink('categories')">
              <span class="icon"><i class="bi bi-bookmark-check"></i></span>
