<template>
    <div class="container-convoz" :class="changeActive === true ? 'content-large' : 'content-short'">
        <h2>Pedidos</h2>
        ...
        <b-row class="row align-items-end container-desk">
            <b-col cols="12" sm="6">
                ...
                <b-form-datepicker id="selected-date" v-model="selectedDate" @input="getOrders()" locale="es-CO" />
            </b-col>
            <b-col cols="12" sm="6">
                <div v-if="idRol === 1 || idRol === 3" class="d-flex justify-content-end">
                    <b-dropdown
                        v-if="idRol === 1"
                ...
                <div class="modal-content">
                    <b-form @submit.prevent="createOrder()">
                        ...
                        <div class="modal-body">
                            <b-row>
                                <b-col cols="6">
                                    <b-form-group class="mb-3" label="Nombre:" label-for="name">
                                        <b-form-input id="name" v-model="orderData.client.name" required></b-form-input>
                                    </b-form-group>
                                </b-col>
                                <b-col cols="6">
                                    <b-form-group class="mb-3" label="Apellido:" label-for="lastname">
                                        <b-form-input
                                            id="lastname"
                            ...
                            <b-row>
                                <b-col cols="12">
                                    <b-form-group class="mb-3" label="Dirección:" label-for="address">
                                        <b-form-input id="address" v-model="orderData.address" required></b-form-input>
                                    </b-form-group>
                                </b-col>

                                <b-col cols="12">
                                    <b-form-group class="mb-3" label="Teléfono:" label-for="phone">
                                        <b-form-input id="phone" v-model="orderData.phone" required></b-form-input>
                                    </b-form-group>
                                </b-col>
                            </b-row>
                            ...
                            <b-row>
                                ...
                                <b-col cols="6">
                                    <b-form-group class="mb-3" label="Barrio:" label-for="neighborhood">
                                        <b-form-input
                                            id="neighborhood"
                            ...
                            <b-row>
                                <b-col cols="6">
                                    <b-form-group class="mb-3" label="Recaudo:" label-for="amount">
                                        <b-form-input
                                            id="amount"
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-closer" data-bs-dismiss="modal" @click="cleanData()">
                                Cerrar
                            </button>
                ...
                <div class="modal-content">
                    <b-form @submit.prevent="createOrder()">
                        ...
                        <div class="modal-body">
                            <b-row>
                                <b-col v-if="orderId" cols="6">
                                    <b-form-group label="" label-for="status" class="mb-3">
                                        <b-form-select
                                ...
                                <b-col cols="6">
                                    <b-form-group class="mb-3 zone-btn" label="" label-for="zone">
                                        <b-form-select
                                            class="badge bg-secondary"
                                            v-model="orderData.zone"
                                            :options="['Norte', 'Sur']"
...
export default {
    ...
    methods: {
        ...
        async getOrders() {
            try {
                const dateISO = new Date(this.selectedDate).toISOString().split("T")[0];

                const q = query(ordersRef, orderByChild("date"), startAt(dateISO), endAt(`${dateISO}\uf8ff`));
                ...
                await onValue(q, snapshot => {
                    ...
                    if (this.idRol === 2) {
                        if (this.user.store_id) {
                            this.orders = this.orders.filter(order => order.store_id === this.user.store_id);
                        } else {
                            this.orders = [];
                        }
                    }
                    ...
                    if (this.idRol === 3) {
                        this.orders = this.orders.filter(order =>
                            this.stores.some(store => store.id === order.store_id)
                        );
                    }
        ...
        getDriversByStore() {
            const driverId = this.stores.find(store => store.id == this.selectedStore).driver_id;

            this.driversByStore = this.drivers.filter(driver => driver.id == driverId);
        },
        checkCurrentDate() {
