<template>
  <div class="mt-3">
    <div
      :class="changeActive ? 'content navigation open' : 'content navigation'"
    >
      ...
      <ul>
        <li class="list" style="--clr: #f44336">
          <a href="#">
            ...
            <span class="text">{{
              user && user.name ? user.name + " " + user.lastname : "User test"
            }}</span>
          </a>
        </li>
        <li
        ...
        <li
          :class="attitudesActive ? 'list active' : 'list'"
          style="--clr: #0fc70f"
        >
        ...
        <li
          :class="sectorsActive ? 'list active' : 'list'"
          style="--clr: #2196f3"
        >
        ...
        <li
          :class="postulationsActive ? 'list active' : 'list'"
          style="--clr: #2196f3"
        >
        ...
        <li
          :class="logoutActive ? 'list active' : 'list'"
          style="--clr: #d321f3"
        >
