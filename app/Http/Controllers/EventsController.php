...
class EventsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        switch ($filterParam) {
            ...
            case 'accept':
                $user_id = Auth::user()->id;
                $eventsUsers = EventsUsers::where('id_user', $user_id)->where('status',
                    $filterParam)->with('events')->get();
...
//        return $request->all();
        ...
        try {
            ...
            if ($request->hasFile('banner')) {
                $bannerUrl = Uploader::uploadFile('banner', 'Eventbanners');
            }
            ...
            $newEvent->banner = $bannerUrl;
            $newEvent->typePersonal = $request->typePersonal;
            $newEvent->initialDate = $request->initialDate;
            $newEvent->endDate = $request->endDate;
            $newEvent->hourly = json_decode($request->hourly);
