...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::put('user_update/{user_id}',[App\Http\Controllers\ProfileUserController::class, 'updateUser']);	
...
Route::post('passwordUpdate', [App\Http\Controllers\ProfileUserController::class, 'updatePassword']);
